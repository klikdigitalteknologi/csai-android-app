...
public class SendFileResponse {
    ...
    public static class MessageData {
        private PdfMessageData documentMessage;

        public PdfMessageData getDocumentMessage() {
            return documentMessage;
        }

        public void setDocumentMessage(PdfMessageData documentMessage) {
            this.documentMessage = documentMessage;
        }
    }

    public static class PdfMessageData {
        private String url;
